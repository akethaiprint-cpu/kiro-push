// @ts-nocheck
/**
 * Storage Manager (verbatim port จาก js/storage.js)
 * พอร์ตทั้งก้อนเพื่อคง getDefaultPriceTable() ให้ตรงกับเว็บเดิม (regression baseline)
 * หมายเหตุ: เมธอด localStorage/Google Sheets เป็นของเว็บเดิม ไม่ถูกเรียกจากโดเมน/เทสต์
 * ใช้เฉพาะ getDefaultPriceTable() ซึ่งเป็น pure — เข้าถึงผ่าน default-price-table.ts
 */
